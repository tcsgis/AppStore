...
import com.changhong.util.http.AsyncHttpResponseHandler;
import com.changhong.util.http.FileHttpResponseHandler;
...
public class DownloadManager extends Thread
{
	...
	private DownloadManager(String rootPath)
	{
		...
		if (!CHStringUtils.isEmpty(rootPath))
		{
			...
			throws MalformedURLException
	{
		FileHttpResponseHandler handler = new FileHttpResponseHandler(url,
				rootPath, CHStringUtils.getFileNameFromUrl(url))
		{
			...
			{
				// TODO Auto-generated method stub
				CHLogger.d(DownloadManager.this, "Throwable");
				if (error != null)
				{
