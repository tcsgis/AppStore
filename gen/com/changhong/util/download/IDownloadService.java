 ...
 * Original file: D:\\Github\\AppStore\\src\\com\\changhong\\util\\download\\IDownloadService.aidl
 */
package com.changhong.util.download;
public interface IDownloadService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.changhong.util.download.IDownloadService
{
private static final java.lang.String DESCRIPTOR = "com.changhong.util.download.IDownloadService";
...
/**
 * Cast an IBinder object into an com.changhong.util.download.IDownloadService interface,
 * generating a proxy if needed.
 */
public static com.changhong.util.download.IDownloadService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.changhong.util.download.IDownloadService))) {
return ((com.changhong.util.download.IDownloadService)iin);
}
return new com.changhong.util.download.IDownloadService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.changhong.util.download.IDownloadService
{
